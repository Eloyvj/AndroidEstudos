...
public class MainActivity extends AppCompatActivity {
    ...
    private final String SAVED_RECYCLER_VIEW_LAYOUT = "recycler_state";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelable(SAVED_RECYCLER_VIEW_LAYOUT, mRecyclerView.getLayoutManager().onSaveInstanceState());
    }
}
